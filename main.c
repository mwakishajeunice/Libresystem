...
{
    gotoxy(20,4);
    printf("Only two sections are available as below in this library\n");
    gotoxy(20,5);
    printf("1.USER AREA");
    gotoxy(20,6);
    printf("2.ADMIN AREA");
...
void mainmenu()
{
 ...
 case '4':
  ...
  delay(3000);//To delay the exit in about 3 secs
  exit(0);//exits the application after the 3 secs are over
     }
     default:
  {
  gotoxy(10,23);
...
//will help the user register as a member of the system
registe()
{
    FILE *log;
...
//will help the user to login into the system
login()
{
...
//will be used by the user to  search  books or exit the section
void after_login(void)
{ 
	int number;
	  gotoxy(20,5);
...
// help the user to navigate to registration and login section in the project
 User()
{
   int number;
    gotoxy(20,5);
