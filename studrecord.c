...
void add_student(){
    ...
    if(fp == NULL){
        ...
        fflush(stdin);
        gotoxy(37,10);printf("ID: ");gets(stu.ID);
        //here you can confirms the ID
        gotoxy(37,12);printf("Name: ");gets(stu.name);
        gotoxy(37,14);printf("Address: ");gets(stu.add);
        gotoxy(37,16);printf("Parent's name: ");gets(stu.parname);
        gotoxy(37,18);printf("Class: ");scanf("%d",&stu.Class);
        gotoxy(37,20);printf("Phone Number: ");scanf("%ld",&stu.phone_no);
