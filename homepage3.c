...
{
	FILE *log; 
	log=fopen("logins.dat","a+"); //open a login file for reading and updating
	struct login a;
...
void addbooks(void)
{
    ...
    int n;
    FILE *fp;
    fp=fopen("booksinfos.dat","a+"); //open sample login file for appending and updating
